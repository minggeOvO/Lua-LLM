...
def get_c4(nsamples, seed, seqlen, tokenizer):
    ...
    traindata = load_dataset('../datasets/allenai/c4',  data_files={'train': 'en/c4-train.00000-of-01024.json.gz'}, split='train')
    valdata = load_dataset('../datasets/allenai/c4',  data_files={'validation': 'en/c4-validation.00000-of-00008.json.gz'}, split='validation')
